...
$$
da cui questo diminuisce cresce con $d_H(\mathbf{x}, \mathbf{y})$ (in quanto $\frac{p}{1- p} < 1$ se $p < \frac{1}{2}$), e massimizzare la verosomiglianza $P(\mathbf{y} | \mathbf{x})$ equivale a minimizzare la distanza di Hamming $d_H(\mathbf{x}, \mathbf{y})$.
