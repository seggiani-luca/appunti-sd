...
Dato un esperimento casuale di modello di probabilità assegnato, ad ogni suo risultato $\omega_i$ assegnamo una funzione reale $x(t, \omega)$ sulla variabile (solitamente tempo) $t$. Abbiamo così definito un insieme di funzioni $X(t, \omega)$, dette \textbf{processi aleatori}. 
