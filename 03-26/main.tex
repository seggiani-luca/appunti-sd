...
\begin{cases}
f_0 < -2B \rightarrow 0 \\
-2B < f_0 < 0 \rightarrow \int_{-B}^{f_0 + B} \frac{1}{4B^2} \, dv  \\ 
0 < f_0 < 2B \rightarrow \int_{f_0 - B}^{B} \frac{1}{4B^2} \, dv \\ 
f_0 > 2B \rightarrow 0 \\
\end{cases}
$$
...
Z(f) =
\begin{cases}
	\frac{1}{2B} \left( \frac{f}{2B} + 1 \right), \quad -2B < f < 0 \\
	\frac{1}{2B} \left( 1 - \frac{f}{2B} \right), \quad 0 < f < 2B \\
...
-\frac{3}{4}T < t_0 < -\frac{1}{4}T \rightarrow \int_{-T}^{t_0 + \frac{1}{4}T} d\tau \\
-\frac{1}{4}T < t_0 < \frac{1}{4}T \rightarrow \int_{t_0 - \frac{1}{4}T}^{t_0 + \frac{1}{4}T} d\tau \\
\frac{1}{4}T < t_0 < \frac{3}{4}T \rightarrow \int_{t_0 - \frac{T}{4}}^{T} d\tau \\
t_0 > \frac{3}{4} \rightarrow 0 \\
\end{cases}
$$
...
\begin{cases}
t + \frac{3}{4}T, \quad -\frac{3}{4}T<t<-\frac{1}{4}T \\
\frac{T}{2}, \quad -\frac{1}{4}T<t<\frac{1}{4}T \\
-t + \frac{3}{4}T, \quad -\frac{3}{4}T<t<-\frac{1}{4}T \\
0, \quad \text{altrimenti}
\end{cases}
$$
