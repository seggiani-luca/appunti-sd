...
\noindent
Dalla la funzione distribuzione di probabilità congiunta, come per il caso monodimensionale, si puà calcolare una funzione \textbf{densità di probabilità congiunta}: 
$$
f_{XY} = \frac{\partial^2 F_{XY}(x, y)}{\partial x \partial y}
$$
ammesso che la distribuzione sia derivabile fino al secondo grado. Varrà quindi:
$$
...
$$
Da cui segue che anche la densità di probabilità congiunta si fattorizza nel prodotto delle due densità di probabilità marginali:
$$
