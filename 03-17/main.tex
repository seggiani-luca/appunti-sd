...
Possiamo ottenere dei risultati interessanti interrogandoci sulla coerenza dimensionale (in termini fisici) dell'ultima espressione ricavata. Infatti il termine $\tau$, che nel contesto dell'$x(t)$ originale rappresentava un tempo, ora va a moltiplicare un tempo (cosa che fisicamente a poco significato). Possiamo quindi imporre una cosa del tipo:
$$
\tau = 2 B
$$
