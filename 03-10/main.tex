...
$$
A_\mathrm{dB} = 10 \log_{10} \left( \frac{A^2}{A_0^2} \right) = 20 \log_{10} \left( \frac{A}{A_0} \right)
$$
...
Se sostituiamo l'area $A$ con l'\textit{area efficiente}, che intendiamo come una misura dell'area che l'antenna offre al fronte d'onda del segnale (ricavata da caratteristiche elettriche e non geometriche):
$$
...
$$
f = \left[3\cdot10^{9},\ 300\cdot10^{9}\right]
$$
...
$$
\begin{center}
	\includegraphics[scale=0.28]{../figures/snr.png}
\end{center}
