...
$$
p(t) = \mathrm{rect} \left( \frac{t - \frac{T}{2}}{T} \right) \rightarrow P(f) = T \mathrm{sinc}(f T) e^{-i \pi f T}
$$
...
$$
p(t) = \mathrm{tri} \left( \frac{t - \frac{T}{2}}{2T} \right) \rightarrow P(f) = T \mathrm{sinc}^2(f T) e^{-i \pi f T}
$$
dove notiamo il $2$ a denominatore è dato dal fatto che la $\mathrm{tri}$ si deve estendere a sinistra e a destra del punto campionato (per interpolare appunto linearmente da entrambi i lati).
