...
\begin{itemize}
	...
	\item \textbf{FDMA} (\textit{Frequency Division Multiple Access}): si divide lo \textit{spettro} del mezzo in più \textit{bande} di frequenza, allocata ognuna ad un diverso trasmettitore.
