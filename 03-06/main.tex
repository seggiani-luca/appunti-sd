...
Questi corrispondono al segnale originale che volevamo campionare nello scorso esempio, come ai segnali elettrici campionati e poi amplificati ($v(t)$ e $x(t)$);
	\item Chiamiamo \textbf{sequenze} i segnali disccontinui nel tempo e continui nelle ampiezze:
\begin{center}
...
Questa legge è applicabile in astratto, per cui dato un qualunque segnale $x(t)$ (qui era $I(t)$) la potenza \textit{istantanea} che esso esprime sarà proporzionale al suo quadrato:
$$
P(t) = |x|^2 (t)
$$
...
\noindent
Data una definizione di \textit{potenza}, espressa come:
$$
P = \frac{E}{t}
$$
cioè energia $E$ su tempo $t$, è appunto semplice dare una definizione di \textbf{energia} dissipata su un certo periodo temporale. Questa, dagli strumenti di analisi, potrà essere calcolata come l'integrale:
$$
E = \int P(t) \, dt = \int |x|^2 (t) \, dt
$$
...
$$
su un certo intervallo temporale $[t_0, t_1]$. Prendiamo il segnale:
$$
x_T (t) = \{ t_0 < t < t_1 : \, x(t), \, 0 \text{ altrimenti} \}
$$
come la versione \textbf{troncata} sull'intervallo $[t_0, t_1]$ del segnale $x(t)$.
Spostandoci sull'intervallo:
$$
[t_0, t_1] = [-\frac{T}{2}, \frac{T}{2}] 
$$
per una qualche dimensione di \textit{finestra} $T$, cioè la finestra centrata sull'origine, questo diventa:
$$
P_{x_T} = \frac{E_{x_T}}{T} \, \quad E_{x_T} = \int_{-\frac{T}{2}}^{\frac{T}{2}} x^2 (t) \, dt
$$
di cui prendiamo il limite per $T \rightarrow + \infty$:
$$
...
$$
Useremo questa definizione come definizione effettiva di \textbf{potenza media}. 
