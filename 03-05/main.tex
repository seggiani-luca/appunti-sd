...
1a. & $A \cup A = A$ & 1b. $A \cap A = A$ \\ \hline

\multicolumn{3}{|c|}{\textbf{Leggi associative}} \\ \hline
2a. & $(A \cup B) \cup C = A \cup (B \cup C)$ & 2b. $(A \cap B) \cap C = A \cap (B \cap C)$ \\ \hline

\multicolumn{3}{|c|}{\textbf{Leggi commutative}} \\ \hline
3a. & $A \cup B = B \cup A$ & 3b. $A \cap B = B \cap A$ \\ \hline

\multicolumn{3}{|c|}{\textbf{Leggi distributive}} \\ \hline
4a. & $A \cup (B \cap C) = (A \cup B) \cap (A \cup C)$ & 4b. $A \cap (B \cup C) = (A \cap B) \cup (A \cap C)$ \\ \hline

\multicolumn{3}{|c|}{\textbf{Leggi di identità}} \\ \hline
5a. & $A \cup \emptyset = A$ & 5b. $A \cap U = A$ \\ \hline
6a. & $A \cup U = U$ & 6b. $A \cap \emptyset = \emptyset$ \\ \hline

\multicolumn{3}{|c|}{\textbf{Leggi di complementarietà}} \\ \hline
7a. & $A \cup A^c = U$ & 7b. $A \cap A^c = \emptyset$ \\ \hline
8a. & $(A^c)^c = A$ & 8b. $U^c = \emptyset$, $\emptyset^c = U$ \\ \hline
