...
\noindent
\textbf{\textsf{Trattazione matematica}}
...
\subsubsection{Teoria della probabilità}
...
\begin{enumerate}
	...
	\end{theorem} 
		Questo si dimostra a partire dall'assioma di \textit{addittività}. In particolare:
		$$
		P(a \cup \bar{a}) = P(a) + P(\bar{a}) = P(\Omega) = 1 \implies P(\bar{a}) = 1 - P(A)
		$$
		ricordando che $a \cup \bar{a} = \Omega$ da cui la tesi. \hfill $\square$
	...
	$$
		P(a_1 \cup a_2 \cup ...) = P(a_1) + P(a_2) + ... = \sum_i P(a_i)
	$$
